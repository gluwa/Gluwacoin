...
/**
 * @dev The proposed new Standard Gluwacoin V2 that extend the existing functions of ERC-20  to support Ethless transactions. 
 * V2 is fully compatible to V1
 */
abstract contract GluwacoinV2 is ERC20Upgradeable {
    enum SigDomain {
        /*0*/
        Nothing,
        /*1*/
